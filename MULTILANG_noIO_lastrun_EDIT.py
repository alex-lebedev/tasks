...
expInfo = {u'session': u'001', u'participant': u'', u'eye-tracking':1, u'task-version': u'SPECIFY TASK CODE HERE'}
...
#save task version
tversion = expInfo['task-version']

if (tversion == 'iA1_SWE'):
	inst_img = 'stim/Instructions/Instructions_iA_SWE.jpg'
	tlist = 'faces_iA1_SWE.xlsx'
	rate_inst_stim = 'stim/Instructions/rate_SWE.jpg'
	who_stim = 'stim/Instructions/WHOA_SWE.jpg'
	
elif (tversion == 'iA2_SWE'):
	inst_img = 'stim/Instructions/Instructions_iA_SWE.jpg'
	tlist = 'faces_iA2_SWE.xlsx'
	rate_inst_stim = 'stim/Instructions/rate_SWE.jpg'
	who_stim = 'stim/Instructions/WHOA_SWE.jpg'
	
elif (tversion == 'uA1_SWE'):
	inst_img = 'stim/Instructions/Instructions_uA_SWE.jpg'
	tlist = 'faces_uA1_SWE.xlsx'
	rate_inst_stim = 'stim/Instructions/rate_SWE.jpg'
	who_stim = 'stim/Instructions/WHOA_SWE.jpg'
	
elif (tversion == 'uA2_SWE'):
	inst_img = 'stim/Instructions/Instructions_uA_SWE.jpg'
	tlist = 'faces_uA2_SWE.xlsx'
	rate_inst_stim = 'stim/Instructions/rate_SWE.jpg'
	who_stim = 'stim/Instructions/WHOA_SWE.jpg'
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\Users\Emotionlab\Desktop\RALT_pupillometry\SWE_ins_noIO_lastrun.py',
...
rate_img = visual.ImageStim(
    ...
    image=rate_inst_stim, mask=None,
...
continueRoutine = True
# update component parameters for each repeat
instructions_img.setImage(inst_img)
...
trials = data.TrialHandler(nReps=1, method='sequential', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions(tlist),
